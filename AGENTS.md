...
3. Прочитай `memory/SESSION_STATE.md` — текущие задачи агентов, активные проекты
4. Прочитай свежий дневной лог (`memory/YYYY-MM-DD.md` за сегодня или вчера) — незавершённые задачи
